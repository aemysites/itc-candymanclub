...
## Environments
- Preview: https://main--itc-candymanclub--aemysites.aem.page/
- Live: https://main--itc-candymanclub--aemysites.aem.live/
- Block Library: https://main--itc-candymanclub--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-candymanclub` directory in your favorite IDE and start coding :)
